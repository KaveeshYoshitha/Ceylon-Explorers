            ...
            <div className="container mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                        From ancient cities to pristine beaches, discover the diverse landscapes and rich cultural heritage of Sri Lanka
                    </p>
                </div>
                        ...
                        >
                            <div className="relative h-72 overflow-hidden group">
                                ...
                                <div className="absolute bottom-4 left-4 text-white">
                                    <h3 className="text-2xl font-heading font-bold">{destination.title}</h3>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-primary font-medium hover:underline cursor-pointer text-[#1b9470]">View Details</span>
                                </div>
                            </div>
                        </div>
                    ))}
